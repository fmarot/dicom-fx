...
public final class displayTag {
	 ...
	 * @throws IOException
	 */
	static Attributes loadDicomObject(File f) throws IOException {
		if (f == null) {
			return null;
		}
	 ...
	 * @param valueBool
	 *            : si true Format yyyy.mm.dd sinon format dd.mm.yyyy/ if true then format yyyy.mm.dd else dd.mm.yyyy
	 * @param valueNoun
	 *            : "dot" mettre la date en format yyyy.mm.dd ou dd.mm.yyyy sinon en format yyyy mm dd ou dd mm yyyy/ "dot" put yyyy.mm.dd or dd.mm.dd or dd.mm.yyyy else yyyy mm or
	 *            dd mm yyyy
	 ...
	 * @param valueBool
	 *            : si true Format yyyy.mm.dd sinon format dd.mm.yyyy/ if true format yyyy.mm.dd else dd.mm.yyyy
	 * @param valueNoun
	 *            : "dot" mettre la date en format yyyy.mm.dd ou dd.mm.yyyy sinon en format yyyy mm dd ou dd mm yyyy/dot" put yyyy.mm.dd or dd.mm.dd or dd.mm.yyyy else yyyy mm or
	 *            dd mm yyyy
	 * @return afficher le string du tag selon le standard international/ return string date
	 ...
	 * @param valueNoun
	 *            : "dot" put the date in format yyyy.mm.dd or dd.mm.yyyy else in format yyyy mm dd or dd mm yyyy
	 * @return
	 */
	public static String FormatDate(String Numero, boolean valueBool, String valueNoun) {

		if (Numero.matches("^[0-9]*$")) {// If la chaine de caract?re est un nombre ou un chiffre
	...
	/**
	 * Les unit?s sp?cifiques selon les tags pour vr= SQ/ Unity specical for tags VR= SQ
	 * 
	 * @param TAG
	 *            :
	 *            - RegionSpatialFormat
	...
	/**
	 * Enregistre l'unit? des items/ Put unity of items
	 * 
	 * @param nounUnit
	...
	/**
	 * On obtient l'unit? des items./Giving unity of items
	 * 
	 * @return le nom de l'unit?
	 */
	...
	/**
	 * Prend la valeur interne d'un tag Item/ Put the value tag ite?
	 * 
	 * @param result
	 * @return
	 */
